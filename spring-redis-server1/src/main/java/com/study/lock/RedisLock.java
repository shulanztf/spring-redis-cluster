 ...
 * @ClassName: RedisLock
 * @Description:
 * @see http://www.cnblogs.com/0201zcr/p/5942748.html
 * @author: zhaotf
 * @date: 2017年9月24日 下午1:36:12
 */
public class RedisLock {
	private static Logger logger = Logger.getLogger(RedisLock.class);
	private static String host = "192.168.0.126";// V310

	public static void main(String[] args) {
		RedisTemplate redisTemplate = new RedisTemplate();

		JedisPoolConfig jedisPoolConfig = new JedisPoolConfig();
		jedisPoolConfig.setMaxWaitMillis(1000);// 最长等待时间，毫秒
